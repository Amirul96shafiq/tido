...
- An ingestion or asynchronous integration is not verified at upload, webhook acceptance, file storage, or job dispatch. When live verification is in scope and locally available, follow the queue to completion and inspect the persisted expense status and populated data.
