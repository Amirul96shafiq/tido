...
final class ManualInvoiceCurrencyConversionService
{
    ...
    public function convert(array $formState): array
    {
        ...
        if ($sourceCurrency === Invoice::CURRENCY_MYR) {
        ...
        $normalizedItems = [];
        $itemKeys = [];
        $itemsState = is_array($formState['invoiceItems'] ?? null) ? $formState['invoiceItems'] : [];
