...
- Set document_classification to receipt when at least one page clearly belongs to a receipt, invoice, bill, utility bill, or payment receipt / online payment confirmation (including myTNB or FPX success pages).
- Set document_classification to not_receipt only when no page contains receipt or payment information.
