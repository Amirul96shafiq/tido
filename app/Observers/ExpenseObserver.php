...
{
    public function creating(Expense $invoice): void
    {
    ...
    public function created(Expense $invoice): void
    {
    ...
    public function updated(Expense $invoice): void
    {
        ...
        if (in_array($invoice->status, ['parsed', 'reviewed'], true)) {
            ...
            if (! $deferForWhatsAppParsed) {
                app(BudgetAlertService::class)->checkAlertsForExpense($invoice);
            }
        }
