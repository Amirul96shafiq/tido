...
<head>
    ...
    <title>Password Reset Link Expired | {{ config('app.name', 'tido') }}</title>
...
<body>
    <div class="container">
        ...
        <h1>Link Expired</h1>
        <p>
            The password reset link has expired. For your security, password reset links are only valid for a limited
            time. Request a new link from the login page to continue.
        </p>

        <a href="/admin/login" class="btn">Return to Login</a>
    </div>
</body>
</html>
