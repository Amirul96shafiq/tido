<div class="grid gap-6 lg:grid-cols-2">
    ...
    <x-filament::section class="order-1 lg:order-2" id="evolution-link-device">
        ...
        >
            ...
            @elseif (filled($this->pairingCode) && ! $this->isConnectionOpen())
                <div
                    wire:key="wa-pair-timer-{{ $this->pairingCodeGeneratedAt }}"
                    x-data="{
                        ttl: {{ \App\Filament\Pages\EvolutionApiPage::CONNECT_TTL_SECONDS }},
                        generatedAt: {{ $this->pairingCodeGeneratedAt }},
                ...
                >
                    ...
                    @if (filled($this->pairingNumber))
                        <p class="text-center text-xs text-gray-500 dark:text-gray-400">
                            Linking account
                            <span class="font-mono text-gray-950 dark:text-white">{{ $this->pairingNumber }}</span>
                        </p>
                    @endif
                    ...
                    <p
                        ...
                        wire:key="wa-pair-code-{{ md5($this->pairingCode) }}"
                    >
                    ...
                    <x-filament::button
                        ...
                        :disabled="blank($this->pairingCode)"
                    >
                        Copy code
                    </x-filament::button>
            ...
            @elseif (filled($this->qrBase64) && ! $this->isConnectionOpen())
                <div
                    wire:key="wa-qr-timer-{{ $this->qrGeneratedAt }}"
                    x-data="{
                        ttl: {{ \App\Filament\Pages\EvolutionApiPage::CONNECT_TTL_SECONDS }},
                ...
                >
                    ...
                    <img
                        ...
                        :class="expired && 'opacity-40'"
                        wire:key="wa-qr-{{ md5($this->qrBase64) }}"
                    />
                </div>
                        ...
                        <dl class="rounded-xl border border-gray-200 px-4 py-3 dark:border-slate-700">
                            <div class="flex flex-row items-baseline justify-between gap-3">
                                ...
                                <dd class="min-w-0 truncate text-right font-mono text-gray-950 dark:text-white">
                                    @if (filled($this->connectedNumber))
                                        <a
                        ...
                        <div class="fi-evolution-api-details">
                            ...
                            >
                                ...
                                @include('filament.pages.partials.evolution-api-details', [
                                    ...
                                    'connectedProfileName' => $this->connectedProfileName,
                                    'connectedVia' => $this->connectedVia?->label(),
                                    'connectedIntegration' => $this->connectedIntegration,
                                    'connectedInstanceId' => $this->connectedInstanceId,
                                    'connectedMessageCount' => $this->connectedMessageCount,
                                    'connectedContactCount' => $this->connectedContactCount,
                                    'connectedChatCount' => $this->connectedChatCount,
                                    'connectedUpdatedAt' => $this->connectedUpdatedAt,
