...
<div
    ...
    x-data="{
        ...
        get showModal() {
            return this.isMobile && ! this.dismissed && (this.loginMode === 'phone' || this.loginMode === 'password');
        },
        syncViewport() {
...
>
    ...
    <div class="tido-auth-login-toast" x-show="showInline" x-cloak>
        ...
        <div class="tido-auth-login-toast-body">
            ...
            <p class="tido-auth-login-toast-description">{{ $toastDescription }}</p>
        </div>
    ...
    >
        <div class="tido-auth-login-toast-modal-backdrop" x-on:click="dismiss()"></div>
        ...
        <div class="tido-auth-login-toast-modal-panel">
            ...
            <div class="tido-auth-login-toast-body">
                <p id="tido-auth-login-toast-modal-title" class="tido-auth-login-toast-title">{{ $toastTitle }}</p>
                <p class="tido-auth-login-toast-description">{{ $toastDescription }}</p>
            </div>
