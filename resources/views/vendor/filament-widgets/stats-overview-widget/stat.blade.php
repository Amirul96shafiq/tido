...
>
    <div class="fi-wi-stats-overview-stat-content min-w-0">
        ...
        @if ($description = $getDescription())
            <div
                {{ (new FilamentComponentAttributeBag)->color(DescriptionComponent::class, $descriptionColor)->class(['fi-wi-stats-overview-stat-description min-w-0']) }}
            >
                <x-tido.text-marquee class="min-w-0 flex-1">
