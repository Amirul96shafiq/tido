    ...
    @foreach ($dropdownPlacements as $placementConfig)
        ...
        @if ($hasTypeFilters)
            <x-filament::dropdown
                ...
                @class([
                    'fi-gsm-toolbar-control fi-gsm-toolbar-filters fi-ta-filters-dropdown fi-gsm-toolbar-menu',
        ...
        @else
            <div
                @class([
                    'fi-gsm-toolbar-control fi-gsm-toolbar-filters fi-gsm-toolbar-filters-unavailable',
                    $placementConfig['class'],
                ])
            >
                <button
