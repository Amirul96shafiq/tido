...
| [realtime-broadcasting.md](realtime-broadcasting.md) | Ops + agents | Reverb + Filament Echo for expense tables, Monthly Spending Overview, Monthly Spending Trend, and database notifications (port 8081) |
