...
- Residual risk outside this finding: SEC-005 still covers unbounded application-file restore extraction; SEC-006/007 cover integrity binding and encryption.
...
- Residual risk outside this finding: SEC-006 still covers archive-to-token binding and atomic consume; SEC-007 still covers encryption and Spatie source include/exclude.
