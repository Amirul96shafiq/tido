...
Until **MH-004** is Verified on a given database, that install still behaves as a single live household (all existing rows backfill to household #1). Public Register is **MH-007** only.
