...
test('admin panel provider does not load outfit from google fonts cdn', function () {
...
test('auth simple pages use mobile bottom and desktop left split layout', function () {
    ...
    expect($authSplitBlock)
        ...
        ->toContain('padding-block: 1rem 1.25rem;')
        ->toContain('scroll-padding-block: 1rem 1.25rem;')
